    ...
    <div className={card.base}>
      ...
      {generateSummary.isPending ? (
        <div className="flex flex-col items-center justify-center py-8 gap-3">
          ...
          <p className="text-xs text-[var(--color-text-muted)]">Analyzing your day...</p>
        </div>
      ) : summary ? (
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            <span className="text-2xl">{summary.emoji}</span>
            <p className="text-sm text-[var(--color-text)] leading-relaxed">{summary.summary}</p>
          </div>
        ...
        <div className="text-center py-6">
          <Sparkles size={24} className="mx-auto mb-2 text-[var(--color-text-muted)]" />
